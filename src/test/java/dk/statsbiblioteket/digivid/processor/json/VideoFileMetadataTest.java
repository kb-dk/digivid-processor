...
public class VideoFileMetadataTest {
    ...
    public void testToJson() throws Exception {
        ...
        videoFileObject.setStartDate(new GregorianCalendar(1992, 01, 23, 18, 00).getTime());
        ...
        VideoFileMetadata VideoFileMetadata = new VideoFileMetadata(videoFileObject);
    ...
    public void testFromJson() throws Exception {
        ...
        VideoFileMetadata.fromJson(json);
    }
}